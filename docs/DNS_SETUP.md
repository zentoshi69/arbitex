# DNS Setup for bitrunner3001.com
...
- `@` = root domain (`bitrunner3001.com`)
- `api` = subdomain (`api.bitrunner3001.com`)
...
dig +short bitrunner3001.com
dig +short api.bitrunner3001.com
```
