    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "X-Robots-Tag", value: "noindex, nofollow" },
          {
            ...
            value: [
              "default-src 'self'",
              `connect-src 'self' ws://localhost:3001 wss://localhost:3001 wss://api.bitrunner3001.com ${rpcHost} https://api.coingecko.com https://api.dexscreener.com https://api.snowtrace.io https://api.avax.network`,
